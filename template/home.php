        ...
        <div class="row">
          <div class="col-lg-10 mx-auto">
            <h1 class="text-uppercase">
              <strong>Well-Tempered Consort</strong>
            </h1>
            <hr>
          </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 mx-auto text-center">
            ...
            <hr class="light my-4">
            <p class="text-faded mb-4">The <em>Well-Tempered Clavier</em> has inspired generations of musicians. [more stuff here]</p>
			<ol class="text-white">
				<li>Build Your Ensemble</li>
